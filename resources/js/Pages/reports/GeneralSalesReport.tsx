            ...
            <section className="p-4">
                ...
                <div className="my-3 flex items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2.5 items-center">
                        ...
                        <a className="flex items-center " href={route("reports.general-sales.export.excel", { reportType: reportType ?? "monthly" })}>
                            <svg className="shrink-0 size-5 mr-1" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
